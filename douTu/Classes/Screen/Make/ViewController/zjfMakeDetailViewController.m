...
- (void)setWenziColor{
    ...
    _wenZiColorsliderG = [[UISlider alloc]initWithFrame:CGRectMake(SCREENWIDTH+50, 75, SCREENWIDTH-100, 20)];
    _wenZiColorsliderB = [[UISlider alloc]initWithFrame:CGRectMake(SCREENWIDTH+50, 120, SCREENWIDTH-100, 20)];
...
- (void)setbackColor{
    ...
    _backColorsliderG = [[UISlider alloc]initWithFrame:CGRectMake(SCREENWIDTH *2+50, 75, SCREENWIDTH-100, 20)];
    _backColorsliderB = [[UISlider alloc]initWithFrame:CGRectMake(SCREENWIDTH*2+50, 120, SCREENWIDTH-100, 20)];
    ...
    _backColorsliderG.minimumValue = 0;
    _backColorsliderG.maximumValue = 256;
    _backColorsliderG.value = 0;
    _backColorsliderB.minimumValue = 0;
    _backColorsliderB.maximumValue = 256;
...
- (void)changeBack:(UISlider *)slider{
    if (_backColorsliderR.value == 0 && _backColorsliderG.value == 0 && _backColorsliderB.value == 0) {
        _textView.backgroundColor = [UIColor clearColor];
    }else{
...
- (void)shareTextToPlatformType:(UMSocialPlatformType)platformType
{
    ...
    if (_douTuImage.image == nil) {
        UIImage * baseImage = self.localImage;
        
        _resultImage = [baseImage imageWaterMarkWithString:_textView.text point:CGPointMake(_viewsBack.frame.origin.x + 10,_viewsBack.frame.origin.y) attribute:@{NSForegroundColorAttributeName:_textColor,NSFontAttributeName:[UIFont fontWithName:_textFont size:30]}];
    }else{
    ...
    object.shareImage = _resultImage;
